...
/**
 * <pre>
 * AccountType defines the type of account for authentication
 * </pre>
 *
 * Protobuf enum {@code ovgs.v1.AccountType}
 */
public enum AccountType
    implements com.google.protobuf.ProtocolMessageEnum {
  /**
   * <pre>
   * Default/unspecified account type
   * </pre>
   *
  ...
  /**
   * <pre>
   * Human user account tied to identity via authentication mechanism
   * </pre>
   *
  ...
  /**
   * <pre>
   * Service account for programmatic access (e.g., bootstrap server)
   * Can be issued long-lived tokens for automated operations
   * </pre>
   *
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return ovgs.v1.Ovgs.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:ovgs.v1.AccountType)
}
